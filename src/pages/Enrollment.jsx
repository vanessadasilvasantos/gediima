    ...
    return(
        <div className="mx-60 max-xl:mx-30 max-lg:mx-10 max-md:mx-5">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 max-sm:grid-cols-2 max-lg:grid-cols-4 gap-4 max-sm:grid-cols-2 ">
                ...
                <h2 className="text-xl text-[#333] mb-5  mt-10">Inscrição do dia 15/10 a 04/11</h2>
                <div className="grid grid-cols-1 max-sm:grid-cols-2 max-lg:grid-cols-4 gap-4 max-sm:grid-cols-2 ">
                ...
                <h2 className="text-xl text-[#333] mb-5  mt-10">Inscrição feitas no local</h2>
                <div className="grid grid-cols-1 max-sm:grid-cols-2 max-lg:grid-cols-4 gap-4 max-sm:grid-cols-2 ">
